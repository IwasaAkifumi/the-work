...
public class GameRule : MonoBehaviour {
	...
	public Score Score;
	public float Enemy = 5;     //一度に何体のオブジェクトをスポーンさせるか
	...
	public void OnClickButton_ReStart(){
		Application.LoadLevel("Stage1");			// シーン移動
	}
	public void OnClickButton_ReStart2(){
		Application.LoadLevel("Stage2");			// シーン移動
	}
	public void OnClickButton_ReStart3(){
		Application.LoadLevel("Stage3");			// シーン移動
	}
	public void OnClickButton_ReStart4(){
		Application.LoadLevel("Stage4");			// シーン移動
	}
	public void OnClickButton_ReStart5(){
		Application.LoadLevel("Stage5");			// シーン移動
	}
	public void OnClickButton_ReStart6(){
		Application.LoadLevel("Stage6");			// シーン移動
	}
	public void OnClickButton_ReStart7(){
		Application.LoadLevel("Stage7");			// シーン移動
	}
	public void OnClickButton_ReStart8(){
		Application.LoadLevel("Stage8");			// シーン移動
	}
	public void OnClickButton_ReStarta(){
		Application.LoadLevel("aa");			// シーン移動
	}
}